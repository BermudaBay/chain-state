...
// This assertion stays skipped until the SDK ships a `robinhood-testnet` entry
// (chainId 46630n, public keyless provider) AND this repo bumps the pinned SDK
// ref. Un-skip once both have landed; until then `bermuda("robinhood-testnet")`
// throws "no provider configured".
test.skip("should resolve robinhood-testnet to chain id 46630 via the sdk", () => {
  // Arrange
  const slug = "robinhood-testnet";
